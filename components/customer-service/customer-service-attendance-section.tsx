...
export function CustomerServiceAttendanceSection() {
  ...
  return (
    <section className="px-4 pt-7" aria-labelledby="customer-service-attendance-heading">
      <h2
        className="mb-3 text-[length:var(--text-h2)] font-bold text-[var(--color-text-muted)]"
        id="customer-service-attendance-heading"
      >
        สถานะการทำงานวันนี้
      </h2>
